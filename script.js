...
const harryPotter = new Book("Harry Potter and the Sorcerer's Stone", "J.K. Rowling", 235, "https://res.cloudinary.com/bloomsbury-atlas/image/upload/w_568,c_scale/jackets/9781408855652.jpg", "off");
...
function displayBook() {
  ...
  myLibrary.forEach((book) => {
    ...
    bookDiv.innerHTML = `
      ...
      <div class="menu">
        <button type="button" class="readButton ${book.status}"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M200-120v-640q0-33 23.5-56.5T280-840h400q33 0 56.5 23.5T760-760v640L480-240 200-120Zm80-122 200-86 200 86v-518H280v518Zm0-518h400-400Z"/></svg>READ </button>
...
function addEventListenersToBooks() {
  ...
  binBtns.forEach(button => {
    button.addEventListener("click", function() {
        const index = myLibrary.indexOf(myLibrary.find(book => book.id = button.id));
        if (index > -1) { 
...
form.addEventListener("submit", function(e) {
  ...
  if (file) {
    ...
    if (bookData.status === undefined) {
      const bookObject = new Book(bookData.name, bookData.author, bookData.pages, "/images/noCover.png", "off");
    } else {
